        ...
        <div className="container grid grid-cols-12 mx-auto py-10 md:pb-20 lg:place-items-center">
          <div className="col-span-12 lg:col-span-6">
            <h2 className="text-white font-roboto font-bold text-2xl md:text-4xl md:text-center md:leading-normal lg:text-left">
              Get New Projects delivered From us to your inbox weekly.
            </h2>
            <div className="w-full ma-w-[494px] mt-12 space-y-3 mx-auto md:space-y-0 md:flex md:items-center md:space-x-2 lg:mx-0">
              <input
                type="text"
                className="px-4 py-3 rounded-lg w-full placeholder:text-dark-light outline-none"
                placeholder="Your Email"
              />
              <button className="px-4 py-3 rounded-lg w-full bg-primary text-white font-bold md:w-fit md:whitespace-nowrap hover:bg-primary-600">
                Get started
              </button>
            </div>
            <p className="text-dark-light mt-6 text-sm leading-7 md:text-center md:text-base lg:text-left">
            ...
            <div className="w-3/4 mx-auto relative">
              <div className=" w-full rounded-xl bg-white p-3 z-[1] relative">
                <img
                  src={images.CTAimg}
                  alt="post image"
                  className="w-full object-cover object-center h-auto md:h-80 lg:h-80 xl:h-100 "
                />
                <div className="p-5">
